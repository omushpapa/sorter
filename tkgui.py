...
class TkGui(Tk):
	...
	def init_ui(self):
		...
		sort_option = Checkbutton(options_frame, text='Sort folders', variable=self.sort_folders)
		sort_option.pack(side=LEFT)
		recursive_option = Checkbutton(options_frame, text='recursive', variable=self.recursive)
		...
		self.status_bar = Label(self, text='Ready', bd=1, relief=SUNKEN, anchor=W)
